...
function mapping:load_plugin_define()
  self.plugin = {
    ...
    -- Plugin telescope
    ['n|<C-p>']             = map_cr('Telescope find_files'):with_silent(),
    ['n|<leader>fg']        = map_cr('Telescope git_files'):with_silent(),
    ['n|<leader>fw']        = map_cr('Telescope current_buffer_fuzzy_find'):with_silent(),
    ['n|<leader>fW']        = map_cr('Telescope live_grep'):with_silent(),
    ['n|<leader>pw']        = map_cr('lua require("telescope.builtin").grep_string { search = vim.fn.expand("<cword>") }'):with_silent(),
    ['n|<leader>fb']        = map_cr('Telescope buffers'):with_silent(),
    ['n|<leader>fc']        = map_cr('Telescope commands'):with_silent(),
    ['n|<leader>f:']        = map_cr('Telescope command_history'):with_silent(),
    ['n|<leader>ff']        = map_cr('Telescope oldfiles'):with_silent(),
    ...
    ['n|<leader>fs']        = map_cr('Telescope lsp_document_symbols'):with_silent(),
    ['n|<leader>fS']        = map_cr('Telescope lsp_workspace_symbols'):with_silent(),
    ['n|<leader>fa']        = map_cr('Telescope lsp_code_actions'):with_silent(),
    ['n|<leader>fA']        = map_cr('Telescope lsp_range_code_actions'):with_silent(),
    ['n|<leader>gc']        = map_cr('Telescope git_commits'):with_silent(),
